...
// Valid indicates whether the value is a known member of the ContentContextContentType enum.
func (e ContentContextContentType) Valid() bool {
	switch e {
	case Article:
		return true
	case Video:
...
// Valid indicates whether the value is a known member of the ExerciseAnswerSentEventEventType enum.
func (e ExerciseAnswerSentEventEventType) Valid() bool {
	switch e {
	case ExerciseAnswerSentEventEventTypeExerciseAnswerSent:
		return true
	default:
		return false
	}
...
const (
	ExerciseEndedEventEventTypeExerciseEnded ExerciseEndedEventEventType = "exercise.ended"
)

// Valid indicates whether the value is a known member of the ExerciseEndedEventEventType enum.
func (e ExerciseEndedEventEventType) Valid() bool {
	switch e {
	case ExerciseEndedEventEventTypeExerciseEnded:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ExerciseEndedEventOutcome enum.
func (e ExerciseEndedEventOutcome) Valid() bool {
	switch e {
	case Abandoned:
		return true
	case Completed:
...
const (
	ExerciseProgressEventEventTypeExerciseProgress ExerciseProgressEventEventType = "exercise.progress"
)

// Valid indicates whether the value is a known member of the ExerciseProgressEventEventType enum.
func (e ExerciseProgressEventEventType) Valid() bool {
	switch e {
	case ExerciseProgressEventEventTypeExerciseProgress:
		return true
	default:
		return false
	}
...
const (
	ExerciseStartedEventEventTypeExerciseStarted ExerciseStartedEventEventType = "exercise.started"
)

// Valid indicates whether the value is a known member of the ExerciseStartedEventEventType enum.
func (e ExerciseStartedEventEventType) Valid() bool {
	switch e {
	case ExerciseStartedEventEventTypeExerciseStarted:
		return true
	default:
		return false
	}
...
const (
	LessonCompletedEventEventTypeLessonCompleted LessonCompletedEventEventType = "lesson.completed"
)

// Valid indicates whether the value is a known member of the LessonCompletedEventEventType enum.
func (e LessonCompletedEventEventType) Valid() bool {
	switch e {
	case LessonCompletedEventEventTypeLessonCompleted:
		return true
	default:
		return false
	}
...
const (
	LessonResumedEventEventTypeLessonResumed LessonResumedEventEventType = "lesson.resumed"
)

// Valid indicates whether the value is a known member of the LessonResumedEventEventType enum.
func (e LessonResumedEventEventType) Valid() bool {
	switch e {
	case LessonResumedEventEventTypeLessonResumed:
		return true
	default:
		return false
	}
...
const (
	LessonStartedEventEventTypeLessonStarted LessonStartedEventEventType = "lesson.started"
)

// Valid indicates whether the value is a known member of the LessonStartedEventEventType enum.
func (e LessonStartedEventEventType) Valid() bool {
	switch e {
	case LessonStartedEventEventTypeLessonStarted:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PublishOutboxEntryStatus enum.
func (e PublishOutboxEntryStatus) Valid() bool {
	switch e {
	case Dead:
		return true
	case Pending:
...
func (e TrackingEventBaseEventType) Valid() bool {
	switch e {
	case TrackingEventBaseEventTypeExerciseAnswerSent:
		return true
	case TrackingEventBaseEventTypeExerciseEnded:
		return true
	case TrackingEventBaseEventTypeExerciseProgress:
		return true
	case TrackingEventBaseEventTypeExerciseStarted:
		return true
	case TrackingEventBaseEventTypeLessonCompleted:
		return true
...
// Valid indicates whether the value is a known member of the TriggerContextSource enum.
func (e TriggerContextSource) Valid() bool {
	switch e {
	case ChallengeSequence:
		return true
	case FreePractice:
		return true
	case PathExercise:
...
func (t *TrackingEvent) FromLessonStartedEvent(v LessonStartedEvent) error {
	...
	b, err = runtime.JSONMerge(b, []byte(`{"event_type":"lesson.started"}`))
	t.union = b
	return err
}
...
func (t *TrackingEvent) FromLessonResumedEvent(v LessonResumedEvent) error {
	...
	b, err = runtime.JSONMerge(b, []byte(`{"event_type":"lesson.resumed"}`))
	t.union = b
	return err
}
...
func (t *TrackingEvent) FromLessonCompletedEvent(v LessonCompletedEvent) error {
	...
	b, err = runtime.JSONMerge(b, []byte(`{"event_type":"lesson.completed"}`))
	t.union = b
	return err
}
...
func (t *TrackingEvent) FromExerciseStartedEvent(v ExerciseStartedEvent) error {
	...
	b, err = runtime.JSONMerge(b, []byte(`{"event_type":"exercise.started"}`))
	t.union = b
	return err
}
...
func (t *TrackingEvent) FromExerciseProgressEvent(v ExerciseProgressEvent) error {
	...
	b, err = runtime.JSONMerge(b, []byte(`{"event_type":"exercise.progress"}`))
	t.union = b
	return err
}
...
func (t *TrackingEvent) FromExerciseAnswerSentEvent(v ExerciseAnswerSentEvent) error {
	...
	b, err = runtime.JSONMerge(b, []byte(`{"event_type":"exercise.answer_sent"}`))
	t.union = b
	return err
}
...
func (t *TrackingEvent) FromExerciseEndedEvent(v ExerciseEndedEvent) error {
	...
	b, err = runtime.JSONMerge(b, []byte(`{"event_type":"exercise.ended"}`))
	t.union = b
	return err
}
...
type ServerInterface interface {
	// ResolvePublishOutboxEntry Mark a publish_outbox entry as manually resolved
	...
	// RetryPublishOutboxEntry Manually retry a failed Kafka publish
	...
	// IngestTrackingEvent Submit a student tracking event
	// (POST /events)
...
func (siw *ServerInterfaceWrapper) ResolvePublishOutboxEntry(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "event_id", chi.URLParam(r, "event_id"), &eventId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid", ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
