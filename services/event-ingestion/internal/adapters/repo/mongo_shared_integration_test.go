...
// package by TestMain.
//
// Every test here used to start and terminate its own container — 15 of them
// across the two repository suites — which cost about a second each and gave
// the container-readiness race 15 chances to bite instead of one. What that
// bought was isolation, and isolation is cheaper as a database per test (see
