...
// Mutate calls f(ctx, m).
func (f ContentNodeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ContentNodeMutation); ok {
		return f(ctx, mv)
	}
...
// The CourseCheckpointFunc type is an adapter to allow the use of ordinary
// function as CourseCheckpoint mutator.
type CourseCheckpointFunc func(context.Context, *ent.CourseCheckpointMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CourseCheckpointFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CourseCheckpointMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CourseCheckpointMutation", m)
}

// The CourseEnrollmentFunc type is an adapter to allow the use of ordinary
// function as CourseEnrollment mutator.
type CourseEnrollmentFunc func(context.Context, *ent.CourseEnrollmentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CourseEnrollmentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CourseEnrollmentMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f ExpandedContentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ExpandedContentMutation); ok {
		return f(ctx, mv)
	}
...
// function as LearningPath mutator.
type LearningPathFunc func(context.Context, *ent.LearningPathMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LearningPathFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.LearningPathMutation); ok {
		return f(ctx, mv)
	}
...
// function as LearningPathItem mutator.
type LearningPathItemFunc func(context.Context, *ent.LearningPathItemMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LearningPathItemFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.LearningPathItemMutation); ok {
		return f(ctx, mv)
	}
