...
func (_q *PositionQuery) QueryDiagram() *DiagramQuery {
...
func (_q *PositionQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *PositionQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *PositionQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *PositionQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *PositionQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *PositionQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PositionQuery) WithDiagram(opts ...func(*DiagramQuery)) *PositionQuery {
	query := (&DiagramClient{config: _q.config}).Query()
...
//		GroupBy(position.FieldDiagramID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Position.Query().
//		Select(position.FieldDiagramID).
//		Scan(ctx, &v)
...
func (_q *PositionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Position, error) {
	...
	if query := _q.withDiagram; query != nil {
		if err := _q.loadDiagram(ctx, query, nodes, nil,
			func(n *Position, e *Diagram) { n.Edges.Diagram = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PositionQuery) loadDiagram(ctx context.Context, query *DiagramQuery, nodes []*Position, init func(*Position), assign func(*Position, *Diagram)) error {
...
func (_q *PositionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withDiagram != nil {
			_spec.Node.AddColumnOnce(position.FieldDiagramID)
		}
	}
